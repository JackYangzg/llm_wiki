import { copyFile, createDirectory, deleteFile, fileExists, listDirectory, readFile, readFileAsBase64, writeFile } from "@/commands/fs"
...
export function buildGenerationPrompt(
  ...
  return [
    ...
    `  • type     — one of: ${[...GENERATION_WIKI_TYPES, "paper", "method"].join(" | ")}`,
